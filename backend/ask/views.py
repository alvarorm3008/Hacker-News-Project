...
from submissions.serializers import SubmissionAskSerializer
...
def ask(request):
    ...
    return render(request, 'ask/ask.html', {'submissions': submissions, 'query': query})
...
@login_required
def vote_submission_ask(request, submission_id):
